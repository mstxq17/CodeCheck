...
(1, 2, '免责条款', '', '', '', '', 0, 1, UNIX_TIMESTAMP(), '', 0, '', NULL),
(2, 2, '隐私保护', '', '', '', '', 0, 1, UNIX_TIMESTAMP(), '', 0, '', NULL),
(3, 2, '咨询热点', '', '', '', '', 0, 1, UNIX_TIMESTAMP(), '', 0, '', NULL),
(4, 2, '联系我们', '', '', '', '', 0, 1, UNIX_TIMESTAMP(), '', 0, '', NULL),
(5, 2, '公司简介', '', '', '', '', 0, 1, UNIX_TIMESTAMP(), '', 0, '', NULL),
(6, -1, '用户协议', '', '', '', '', 0, 1, UNIX_TIMESTAMP(), '', 0, '', NULL),
...
UPDATE `ecs_shop_config` SET value = 'ecmoban_zsxn' WHERE code = 'template';
UPDATE `ecs_shop_config` SET value = '' WHERE code = 'stylename';
...
('index', '全宽行', '/library/cat_goods.lbi', 0, '132', 6, 1, 'ecmoban_zsxn');
